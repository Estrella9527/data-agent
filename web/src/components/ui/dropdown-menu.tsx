...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "popover-styled overflow-hidden p-1 z-50",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      "[&_svg]:pointer-events-none [&_svg]:shrink-0 [&>svg]:h-3.5 [&>svg]:w-3.5",
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator
    ref={ref}
    className={cn("bg-foreground/[0.1] -mx-1 my-1 h-px", className)}
    {...props}
  />
));
